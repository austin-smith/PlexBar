...
public protocol PlexAccountJWTClient: Sendable {
    func registerJWK(
...
public struct PlexAuthClient: PlexAccountJWTClient, Sendable {
    ...
    public func fetchAuthenticatedUser(
        userToken: String,
        clientContext: PlexClientContext
    ...
    public func fetchJWTNonce(clientContext: PlexClientContext) async throws -> String {
        let request = PlexRequestBuilder(clientContext: clientContext).request(
    ...
    public func fetchServers(userToken: String, clientContext: PlexClientContext) async throws -> [PlexServerResource] {
...
public struct PlexPin: Decodable {
    public let id: Int
...
public enum PlexAuthError: LocalizedError {
    case invalidAuthURL
