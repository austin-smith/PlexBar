...
public enum PlexVideoDynamicRange: String, Equatable, Sendable {
...
public enum PlexDeliveredAudioLayout: String, Equatable, Sendable {
...
public struct PlexNativeMediaDiagnosticFact: Equatable, Identifiable, Sendable {
...
public struct PlexNativeMediaFacts: Equatable, Sendable {
    public let videoWidth: Int?
    public let videoHeight: Int?
    public let videoFrameRate: Double?
    public let videoCodec: String?
    public let dynamicRange: PlexVideoDynamicRange?
    public let videoBitRate: Double?
    public let audioCodec: String?
    public let audioChannelCount: Int?
    public let audioLayout: PlexDeliveredAudioLayout?
    public let audioSampleRate: Double?
    public let audioBitRate: Double?

    public var compactDisplayComponents: [String] {
    ...
    public var diagnosticFacts: [PlexNativeMediaDiagnosticFact] {
    ...
    public var videoDiagnosticFacts: [PlexNativeMediaDiagnosticFact] {
    ...
    public var audioDiagnosticFacts: [PlexNativeMediaDiagnosticFact] {
        diagnosticFacts.filter { fact in
            switch fact.kind {
            case .audioCodec, .channels, .sampleRate, .audioBitRate:
                true
    ...
    public var displayComponents: [String] {
        var components: [String] = []
    ...
    public init(
        ...
        dynamicRange: PlexVideoDynamicRange? = nil,
        videoBitRate: Double? = nil,
        audioCodec: String? = nil,
        audioChannelCount: Int? = nil,
        audioLayout: PlexDeliveredAudioLayout? = nil,
...
public enum PlexNativeMediaInspector {
    @MainActor
    public static func mediaSelectionAvailability(
        asset: AVAsset
    ...
    @MainActor
    public static func inspect(item: AVPlayerItem) async -> PlexNativeMediaFacts? {
    ...
    public static func videoCodecName(for mediaSubtype: FourCharCode) -> String? {
        switch mediaSubtype {
    ...
    public static func audioCodecName(for formatID: AudioFormatID) -> String? {
        switch formatID {
    ...
    public static func audioLayout(for tag: AudioChannelLayoutTag) -> PlexDeliveredAudioLayout? {
        switch tag {
    ...
    public static func dynamicRange(
