...
public struct PlexTimelineRequestParameters {
    public let update: PlexTimelineUpdate
    ...
    public init(update: PlexTimelineUpdate) {
        self.update = update
    }
}

public struct PlexWatchedStateRequestParameters {
