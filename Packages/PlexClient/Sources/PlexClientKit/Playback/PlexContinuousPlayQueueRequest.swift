...
public struct PlexCinemaPlayQueueRequest: Equatable, Sendable {
    public let itemKey: String
    public let sourceURI: String
    public let extrasPrefixCount: Int
...
public struct PlexContinuousPlayQueueRequest: Equatable, Sendable {
    public let itemKey: String
    public let queueType: PlexContinuousPlayQueueType
    public let sourceURI: String
    public let usesOnDeck: Bool
...
public enum PlexPlayQueueMutation: Equatable, Sendable {
    case shuffled(Bool)
    case reset
...
public struct PlexPlayQueueMutationRequest: Equatable, Sendable {
    public let queueID: Int
    public let mutation: PlexPlayQueueMutation

    public init(queueID: Int, mutation: PlexPlayQueueMutation) throws {
    ...
    public var endpointPathComponents: [String] {
        [String(queueID), mutation.endpointComponent]
    }
}

public enum PlexPlayQueueItemMutation: Equatable, Sendable {
    case remove(playQueueItemID: String)
    case move(PlexPlayQueueItemMove)
}

public struct PlexPlayQueueItemMutationRequest: Equatable, Sendable {
    public let queueID: Int
    public let mutation: PlexPlayQueueItemMutation

    public init(queueID: Int, mutation: PlexPlayQueueItemMutation) throws {
        guard queueID > 0 else {
            throw PlexAPIError.invalidPlayQueue
        }
        switch mutation {
