...
public enum PlexSubtitleBurnMode: String, CaseIterable, Identifiable, Sendable {
    case automatic
    case always
...
public enum PlexSubtitleSize: Int, CaseIterable, Identifiable, Sendable {
    case tiny = 60
    case small = 80
    case normal = 100
    case large = 120
...
public struct PlexPlaybackRequestParameters {
    public let item: PlexMediaItem
    public let source: PlexPlaybackSource
    public let videoQuality: PlexVideoQuality
    public let musicQuality: PlexMusicQuality
    public let audioBoost: PlexAudioBoost
    public let streamingPolicy: PlexPlaybackStreamingPolicy
    public let subtitleBurnMode: PlexSubtitleBurnMode
    public let subtitleSize: PlexSubtitleSize
    public let automaticallySyncSubtitles: Bool
    public let automaticallyAdjustVideoQuality: Bool
    public let playSmallerVideosAtOriginalQuality: Bool
    public let forceVideoTranscode: Bool
    ...
    public var permitsDirectPlay: Bool {
    ...
    public var hasMultichannelAudioSource: Bool {
    ...
    public var supportsSubtitleAutoSync: Bool {
        let media = item.media[source.mediaIndex]
        let parts: ArraySlice<PlexMediaPart>
        if source.partIndex >= 0, media.parts.indices.contains(source.partIndex) {
            parts = media.parts[source.partIndex...source.partIndex]
