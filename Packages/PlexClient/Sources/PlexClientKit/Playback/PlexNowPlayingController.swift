...
#if os(macOS)
public struct PlexNowPlayingArtworkRequest: Hashable, Sendable {
    public static let maximumPixelSize = 1_200
...
@MainActor
public final class PlexNowPlayingArtworkLoader {
    public typealias FetchImage = @Sendable (PlexNowPlayingArtworkRequest) async -> PlexCGImageBox?

    private let fetchImage: FetchImage
    private var loadGeneration = 0

    public init(fetchImage: @escaping FetchImage) {
        self.fetchImage = fetchImage
    }

    public func load(_ request: PlexNowPlayingArtworkRequest) async -> CGImage? {
...
public enum PlexNowPlayingArtworkFactory {
    public static func make(from image: CGImage) -> MPMediaItemArtwork {
...
public enum PlexNowPlayingLanguageSelection: Equatable, Sendable {
    case audio(streamID: Int)
    case subtitle(streamID: Int)

    public init?(languageOption: MPNowPlayingInfoLanguageOption) {
...
public struct PlexNowPlayingLanguageOptions {
    public let groups: [MPNowPlayingInfoLanguageOptionGroup]
    public let currentOptions: [MPNowPlayingInfoLanguageOption]
    ...
    public var hasAvailableOptions: Bool {
        !groups.isEmpty
    }
...
public struct PlexNowPlayingMetadata: Equatable, Sendable {
    public struct PublicationFingerprint: Equatable, Sendable {
        ...
        public let creditsStartTime: TimeInterval?
        public let defaultPlaybackRate: Double
        public let itemRatingKey: String
        public let externalContentIdentifier: String?
        ...
        public init(
            ...
            creditsStartTime: TimeInterval? = nil,
            ...
            self.itemRatingKey = itemRatingKey
    ...
    public var publicationFingerprint: PublicationFingerprint {
...
#if os(macOS)
public struct PlexRemotePlaybackActions: Sendable {
    public let play: @MainActor @Sendable () -> Void
    public let pause: @MainActor @Sendable () -> Void
    public let togglePlayPause: @MainActor @Sendable () -> Void
    public let stop: @MainActor @Sendable () -> Void
    public let seek: @MainActor @Sendable (TimeInterval) -> Void
    public let skip: @MainActor @Sendable (TimeInterval) -> Void
    public let selectAudioStream: @MainActor @Sendable (Int) -> Void
    public let selectSubtitleStream: @MainActor @Sendable (Int?) -> Void
    public let changePlaybackRate: @MainActor @Sendable (PlexPlaybackRate) -> Void
    public let changeShuffle: @MainActor @Sendable (Bool) -> Void
    public let changeRepeatMode: @MainActor @Sendable (PlexPlaybackRepeatMode) -> Void
    ...
    public init(
        ...
        selectAudioStream: @escaping @MainActor @Sendable (Int) -> Void,
        selectSubtitleStream: @escaping @MainActor @Sendable (Int?) -> Void,
        changePlaybackRate: @escaping @MainActor @Sendable (PlexPlaybackRate) -> Void,
        changeShuffle: @escaping @MainActor @Sendable (Bool) -> Void,
        changeRepeatMode: @escaping @MainActor @Sendable (PlexPlaybackRepeatMode) -> Void,
        ...
        self.changeShuffle = changeShuffle
...
@MainActor
public final class PlexNowPlayingController {
    ...
    public func updateSeeking(canSeek: Bool) {
    ...
    public func updateLanguageOptions(_ languageOptions: PlexNowPlayingLanguageOptions) {
        self.languageOptions = languageOptions
        updateLanguageCommandAvailability()
    ...
    public func updateLanguageCommandAvailability(canChange: Bool) {
        canChangeLanguageOptions = canChange
        applyLanguageCommandAvailability()
    }

    public func updateShuffle(canChange: Bool, isShuffled: Bool) {
