...
public enum PlexURLBuilder {
    public static func normalizeServerURL(_ rawValue: String) -> URL? {
    ...
    public static func endpointURL(serverURL: URL, path: String) -> URL? {
    ...
    public static func mediaURL(serverURL: URL, path: String?) -> URL? {
    ...
    public static func transcodedArtworkURL(serverURL: URL, path: String?, width: Int, height: Int) -> URL? {
    ...
    public static func transcodedPhotoURL(serverURL: URL, path: String?, width: Int, height: Int) -> URL? {
        guard let path = path?.nilIfBlank,
              width > 0,
              height > 0,
              var components = endpointURL(serverURL: serverURL, path: "/photo/:/transcode")
