...
public struct PlexJSONWebKey: Codable, Equatable, Sendable {
    ...
    public init(publicKey: Curve25519.Signing.PublicKey, keyID: String, includeUse: Bool) {
        kty = "OKP"
        crv = "Ed25519"
...
public struct PlexDeviceSigningIdentity: Equatable, Sendable {
    private static let tokenLifetime: TimeInterval = 5 * 60

    public let keyID: String
    public let privateKeyRepresentation: Data

    public init(keyID: String, privateKeyRepresentation: Data) throws {
    ...
    public static func generate(keyID: String = UUID().uuidString.lowercased()) throws -> PlexDeviceSigningIdentity {
    ...
    public func publicJWK(includeUse: Bool) throws -> PlexJSONWebKey {
        PlexJSONWebKey(
...
public enum PlexAccountToken: Equatable, Sendable {
    case legacy
...
public enum PlexJWTError: LocalizedError {
