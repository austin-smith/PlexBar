...
public struct PlexMediaMetadataFact: Equatable, Identifiable, Sendable {
...
public struct PlexMediaMetadataPresentation: Equatable, Sendable {
    public let facts: [PlexMediaMetadataFact]
